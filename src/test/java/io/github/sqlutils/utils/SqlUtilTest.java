package io.github.sqlutils.utils;
...
class SqlUtilTest {
    ...
    void testFormatSqlQuery() {
        ...
        String formatted = SqlUtil.formatSqlQuery(unformatted);
    ...
    void testModifyWhereClause() {
        ...
        String modifiedQuery = SqlUtil.modifyWhereClause(originalQuery, conditions);
